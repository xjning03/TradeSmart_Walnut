        ...
        <div className="container" id="fraudulent-trading-details-container">
          ...
          <div className="form-group">
            ...
            <select id="activity" name="activity">
              ...
              <option value="Pump and Dump Schemes">
          ...
          <div className="form-group">
            ...
            <p className="explanation">
              ...
              - Any unusual or suspicious behaviors observed <br />- Any
              supporting evidence or documentation (e.g., screenshots,
              transaction records)
            </p>
        ...
        <div className="container" id="legal-disclaimer">
          ...
          <div className="checkbox-group">
            ...
            <label htmlFor="disclaimer2">
              I understand and accept that if any disclosures made are found to
              be false or in breach of any provisions under the Whistleblower
              Protection Act 2010, the protection under the Act maybe revoked or
              affected
            </label>
          </div>
          <div className="checkbox-group">
            ...
            <label htmlFor="disclaimer3">
              I understand and accept that if any disclosures made are found to
              be false or in breach of any other provisions under the
              Whistleblower Protection Act 2010, I may be charged and may lose
              the protection, provided under the Whistleblower Protection Act
              2010
            </label>
          </div>
        </div>
