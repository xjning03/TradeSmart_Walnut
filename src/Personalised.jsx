...
function Personalised() {
  ...
  const filteredStockData = filterStockData(searchQuery).slice(0, 7);
  const filteredCryptoData = filterCryptoData(searchQuery).slice(0, 5);

  return (
    <div className="Personalised" id="Personalised">
        ...
        <div className="container_personalised">
            <div className="Recent">
                ...
                <table className="list-table">
                    ...
                    <tbody>
                    {filteredCryptoData.slice(2,4).map((rowData, index) => (
                        <tr key={index}>
                        <td className="symbol-text">
                            <Link to={`/tradingDetailed`}>{rowData.symbol}</Link>                  
                        </td>
            ...
            <div className="Interest">
                ...
                <table className="list-table">
                    ...
                    <tbody>
                    {filteredStockData.slice(1,5).map((rowData, index) => (
                        <tr key={index}>
                        <td className="symbol-text">
                            <Link to={`/tradingDetailed`}>{rowData.symbol}</Link>                  
                        </td>
